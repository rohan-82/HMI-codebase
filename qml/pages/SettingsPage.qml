            ...
            Column {
                ...
                Row {
                    ...
                    Column {
                        ...
                        Text { text: "Ember"; color: Colors.themeName === "AMBER" ? Colors.textPrimary : Colors.textMuted; font.pixelSize: 17; font.weight: Colors.themeName === "AMBER" ? Font.DemiBold : Font.Normal; anchors.horizontalCenter: parent.horizontalCenter }
                    }
                    ...
                    Column {
                        ...
                        Text { text: "Copper"; color: Colors.themeName === "COPPER" ? Colors.textPrimary : Colors.textMuted; font.pixelSize: 17; font.weight: Colors.themeName === "COPPER" ? Font.DemiBold : Font.Normal; anchors.horizontalCenter: parent.horizontalCenter }
                    }
                }
